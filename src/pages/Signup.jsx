...
const Signup = () => {
  return (
    <div className='w-full bg-gray-100 pt-20 h-screen'>
        <div className='grid sm:grid-cols-2 py-8 px-6 justify-center mx-auto items-center '>
            <div className='border rounded-md py-16 px-7 sm:px-16 mb-8 sm:mb-0 bg-white'>
                ...
                <div className='flex flex-row gap-6'>
                    <div>
                        ...
                        <input type="text" placeholder='firstname' className='border rounded-md border-[#059669] py-2 px-2'  />
                    </div>
                    <div>
                        <p className='py-3'>Lastname</p>
                        <input type="text" placeholder='lastname' className='border rounded-md border-[#059669] py-2 px-2' />
                    </div>
                </div>
                ...
                <div className='flex flex-row gap-6'>
                    <div>
                        ...
                        <input type="email" placeholder='eg.kani@gmail.com' className='border rounded-md border-[#059669] py-2 px-2'  />
                    </div>
                    <div>
                        <p className='py-3'>Mobile</p>
                        <input type="text" placeholder='phone no..' className='border rounded-md border-[#059669] py-2 px-2' />
                    </div>
                </div>
                ...
                <div className=''>
                    ...
                    <button className='border rounded-md border-[#059669] border-2 px-3 py-1 mt-2 text-[#059669] font-bold'>Browse file</button>
                </div>

                <div className='flex justify-end py-2'>
                    <button className='text-white bg-[#059669] rounded-md px-2 py-2'>Save Changes</button>
                </div>
            </div>
